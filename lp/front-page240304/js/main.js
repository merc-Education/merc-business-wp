...
function toggleAttrValue($target, attr, value1, value2) {
  if ($target.attr(attr) === value1) {
    $target.attr(attr, value2);
  } else {
    $target.attr(attr, value1);
  }
}
...
$(function () {
  ...
  $("#voice-list").slick({
    ...
    dots: false,
    arrows: true,
    prevArrow: '<button class="slick-prev" title="前へ"></button>',
    nextArrow: '<button class="slick-next" title="次へ"></button>',
    responsive: [
      {
        breakpoint: 812,
        settings: {
