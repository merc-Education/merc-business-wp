<?php
/*
Template Name: LP（Ver.3）
*/
?>
<?php
$imgPath = getChildThemePath('/lp/front-page4/img');
$stylePath = getChildThemePath('/lp/front-page4/css');
$jsPath = getChildThemePath('/lp/front-page4/js');
?>
			...
			<div class="l-layout__l p-mv__block">
				<div class="p-mv-recruit">
					...
					<div class="p-mv-recruit-detail">
						<p class="p-mv-recruit-detail__number">17期生募集中</p>
						<p class="p-mv-recruit-detail__time">7月開講</p>
					</div>
				</div>
		...
		<div class="p-bg">
			...
			<section class="p-voice" id="voice">
				<div class="l-layout__m">
					...
					<ul class="p-voice-list">
						<li class="p-voice-list__item">
							...
							<p class="p-voice-list__ttl">「お客さん対自分」から「お客さん対市場」へと視座の高まりを実感</p>
						...
						<li class="p-voice-list__item">
							...
							<p class="p-voice-list__ttl">実践をまじえながら人の深層心理を<br>考える授業スタイルは唯一無二</p>
						...
						<li class="p-voice-list__item">
							...
							<p class="p-voice-list__ttl">授業内容をそのままトレースして<br>日本酒ECサイトをリブランディング</p>
						...
						<li class="p-voice-list__item">
							...
							<p class="p-voice-list__ttl">採用にも活きる思考。10人規模の<br>町工場が応募者年間100人以上</p>
						...
						<li class="p-voice-list__item">
							...
							<p class="p-voice-list__ttl">マーケティングを武器にコンテンツの<br>中身まで作れるデザイナーに</p>
						...
						<li class="p-voice-list__item">
							...
							<p class="p-voice-list__ttl">実践を繰り返すことで「分かる」から<br>「できる」への変化を実感</p>
					...
					<div class="p-advantages__block">
						...
						<div class="p-advantages-02">
							<div class="p-advantages-02-list">
								...
								<div class="p-advantages-02-list__item">
									<div class="p-advantages-02-list__scroll">
					...
					<div class="p-advantages__block">
						...
						<div class="p-advantages-03">
							<dl class="p-advantages-03-define">
								...
								<dt class="p-advantages-03-define__ttl">2023.4月</dt>
								<dd class="p-advantages-03-define__txt">
									<dl class="p-advantages-03-content">
								...
								<dt class="p-advantages-03-define__ttl">2023.3月</dt>
								<dd class="p-advantages-03-define__txt">
									<dl class="p-advantages-03-content">
										<dt class="p-advantages-03-content__ttl">応用講座</dt>
										<dd class="p-advantages-03-content__txt">【マーケティングの知識に+α】提案力が高まる論理構成の仕方</dd>
									</dl>
								</dd>
								<dt class="p-advantages-03-define__ttl">2023.2月</dt>
								<dd class="p-advantages-03-define__txt">
									<dl class="p-advantages-03-content">
										<dt class="p-advantages-03-content__ttl">応用講座</dt>
										<dd class="p-advantages-03-content__txt">【マーケティング戦略講座延長編】ブランドコンセプトを設計せよ</dd>
									</dl>
								</dd>
								<dt class="p-advantages-03-define__ttl">2023.1月</dt>
								<dd class="p-advantages-03-define__txt">
									<dl class="p-advantages-03-content">
										<dt class="p-advantages-03-content__ttl last">応用講座</dt>
										<dd class="p-advantages-03-content__txt last">ブランドを意識したファンの作り方</dd>
									</dl>
								</dd>
							</dl>
			...
			<section class="p-comparison" id="comparison">
				<div class="l-layout__l">
					...
					<div class="p-comparison__scroll">
						<table>
							<thead>
								<tr>
									<th></th>
							...
							<tbody>
								...
								<tr>
									<th>講師の質・<br class="u-sp">話の一貫性</th>
									<td>大手マーケティング企業から毎年研修を<br>リピートされる超人気講師1名</td>
									<td>経営の知識と<br class="u-sp">豊富な実務経験がある<br>講師が複数名</td>
									<td>経営の知識と<br class="u-sp">豊富な実務経験がある<br>講師が複数名</td>
								</tr>
								<tr>
									<th>期間</th>
			...
			<section class="p-process" id="process">
				...
				<div class="p-process-btn"><a href="<?php echo $imgPath; ?>/home/img_process_popup.png" class="p-process-btn__link">図を拡大する</a></div>
			</section>
			...
			<section class="p-outline" id="outline">
				<div class="l-layout__s">
					<h2 class="c-heading">「マーケティング戦略講座17期」<br class="u-sp">募集概要<span class="c-heading__en">OUTLINE OF APPLICATION</span></h2>
					<table>
						<tr>
							<th>実施期間</th>
							<td>
								<div class="p-outline-time">
									<p class="p-outline-time__txt">第1回：7/11（火）20:00~22:00<br>第2回：7/18（火）20:00~22:00<br>第3回：7/25（火）20:00~22:00<br>第4回：8/1（火）20:00~22:00</p>
									<p class="p-outline-time__txt">第5回：8/8（火）20:00~22:00<br>第6回：8/22（火）20:00~22:00<br>第7回：8/29（火）20:00~22:00<br>第8回：9/5（火）20:00~22:00</p>
									<p class="p-outline-time__txt">第9回：9/12（火）20:00~22:00<br>第10回：9/19（火）20:00~22:00<br>第11回：9/26（火）20:00~22:00<br>第12回：10/3（火）20:00~22:00</p>
								</div>
						...
						<tr>
							<th>費用</th>
							<td>
								<p class="p-outline__price">授業料：<span>税抜</span>268,000円<br class="u-sp"><span>（税込294,800円）</span><span class="plus">+</span>入学金：<span>税抜</span>30,000円<br class="u-sp"><span>（税込33,000円）</span></p>
								<ul class="p-outline-notes">
			...
			<section class="p-faq" id="faq">
				<div class="l-layout__s">
					...
					<dl class="p-faq-define">
						...
						<dd class="p-faq-define__txt">現在募集しているのは2023年7月開講になります。その後は2023年10月の開講を予定しております。具体的な日程はお問い合わせください。</dd>
					</dl>
				</div>
			</section>
			<div class="c-btn">
