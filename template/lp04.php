<?php
/*
Template Name: LP（Ver.4）
*/
?>
<?php
$imgPath = getChildThemePath('/lp/front-page5/img');
$stylePath = getChildThemePath('/lp/front-page5/css');
$jsPath = getChildThemePath('/lp/front-page5/js');
?>
