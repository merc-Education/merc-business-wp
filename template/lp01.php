<?php
/*
Template Name: LP（Ver.1）
*/
$imgPath = getChildThemePath('/lp/front-page2/img');
$stylePath = getChildThemePath('/lp/front-page2/css');
$jsPath = getChildThemePath('/lp/front-page2/js');
?>
						...
						<li>
							<a href="<?php echo home_url("/registration"); ?>">
								<picture>
									...
									<img loading="lazy" src="<?php echo $imgPath; ?>/btn_app_course_sp.png" alt="いますぐ講座に申し込む（申込フォームに遷移します）">
								</picture>
							</a>
						</li>
					</ul>
	...
	<main>
		<section id="mv">
			...
			<div class="wrap">
				...
				<div class="image sp">
					<picture>
						<source srcset="<?php echo $imgPath; ?>/img_mv_sp.webp" type="image/webp">
						<img src="<?php echo $imgPath; ?>/img_mv_sp.jpg" alt="">
					</picture>
				</div>
				<div class="skill">
					<picture>
						<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/img_mv_skill_sp.webp" type="image/webp">
						<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/img_mv_skill_sp.png">
						<source srcset="<?php echo $imgPath; ?>/img_mv_skill.webp" type="image/webp">
						<img src="<?php echo $imgPath; ?>/img_mv_skill.png" alt="3ヶ月で実務に活かせるスキルを習得！">
					</picture>
				</div>
		...
		<div class="app_box_mv cta">
			<div class="wrap">
				<h2 class="ttl cta__title">
					<picture>
						<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/cta_heading_sp.webp" type="image/webp">
						<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/cta_heading_sp.png">
						<source srcset="<?php echo $imgPath; ?>/cta_heading_pc.webp" type="image/webp">
						<img src="<?php echo $imgPath; ?>/cta_heading_pc.png" alt="マーケティング戦略講座 12月開講 18期生募集中 月額12,417円～（税抜）">
					</picture>
				</h2>
				<ul class="btn c-button-wrapper">
					<li>
						...
						<button onclick="openEeasy('戦略講座')">
							<picture>
								<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/btn_app_free_sp.webp" type="image/webp">
					...
					<li class="c-button--green">
						<a href="<?php echo home_url("/registration"); ?>">
							<picture>
								<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/btn_app_course_sp.webp" type="image/webp">
			...
			<div class="wrap">
				<h2 class="ttl">
					<picture>
						...
						<img loading="lazy" src="<?php echo $imgPath; ?>/img_about_txt1.png" alt="マークエデュケーションはマーケティング戦略に特化したカリキュラムで実務につながるワークショップ中心のスクールです！">
					</picture>
				</h2>
				<ul class="list">
					<li>
						<picture>
							<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/img_about_txt2_sp.webp" type="image/webp">
					...
					<li>
						<picture>
							<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/img_about_txt3_sp.webp" type="image/webp">
			...
			<div class="wrap c-schedule__wrap">
				...
				<div class="box">
					<ul class="list c-schedule__list">
						<li><span>ウェルカムガイダンス</span>12/4（月）20:00-21:30</li>
						<li><span>第1回</span>12/5（火）20:00-22:00</li>
						<li><span>第2回</span>12/12（火）20:00-22:00</li>
						<li><span>第3回</span>12/19（火）20:00-22:00</li>
						<li><span>交流会</span>12/23（土）17:30~19:30</li>
					</ul>
					<ul class="list c-schedule__list">
						<li><span>第4回</span>12/26（火）20:00-22:00</li>
						<li><span>第5回</span>1/9（火）20:00-22:00</li>
						<li><span>第6回</span>1/16（火）20:00-22:00</li>
						<li><span>第7回</span>1/23（火）20:00-22:00</li>
						<li><span>第8回</span>1/30（火）20:00-22:00</li>
					</ul>
					<ul class="list c-schedule__list">
						<li><span>第9回</span>2/6（火）20:00-22:00</li>
						<li><span>第10回</span>2/13（火）20:00-22:00</li>
						<li><span>第11回</span>2/20（火）20:00-22:00</li>
						<li><span>第12回</span>2/27（火）20:00-22:00</li>
						<li><span>予備日</span>3/5（火）20:00-22:00</li>
					</ul>
				</div>
			</div>
		</section>
				...
				<section class="point_clm point2">
					...
					<div class="point_image">
						<picture>
							...
							<img loading="lazy" src="<?php echo $imgPath; ?>/img_select_point2_1.png" alt="3ヶ月でここまでできる！受講者が実際に作成した戦略図" class="img_catch">
						</picture>
						<div class="img_zoom">
							<picture>
				...
				<section class="point_clm point3">
					...
					<div class="point3-block">
						...
						<picture>
							...
							<img loading="lazy" src="<?php echo $imgPath; ?>/img_select_point3_1.png" class="point3-block__badge" alt="これだけ学べてしかも無料">
						</picture>
					</div>
					<div class="list_box">
						<div class="list_clm">
		...
		<div class="app_box">
			<div class="wrap">
				<p class="ttl"><span class="inner">12月開講<br class="sp"><span class="bg">18期</span>受講生募集中！</span></p>
		...
		<section id="interview">
			<div class="wrap">
				<h2 class="interview_ttl">
					<picture>
						<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/img_interview_ttl_sp.webp" type="image/webp">
						<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/img_interview_ttl_sp.png">
						<img loading="lazy" src="<?php echo $imgPath; ?>/img_interview_ttl.png" alt="受講後にできるようになったこと　受講生の声は「#mercedu」で検索！">
					</picture>
				</h2>
				<section class="interview_clm interview_01">
					<p class="att pc">※写真はイメージです</p>
					<p class="number"><img loading="lazy" src="<?php echo $imgPath; ?>/txt_interview_01.svg" alt="Interview01"></p>
					<div class="img">
						<picture>
				...
				<section class="interview_clm interview_02">
					<p class="number"><img loading="lazy" src="<?php echo $imgPath; ?>/txt_interview_02.svg" alt="Interview02"></p>
					<div class="img">
						<picture>
				...
				<section class="interview_clm interview_03">
					<p class="number"><img loading="lazy" src="<?php echo $imgPath; ?>/txt_interview_03.svg" alt="Interview03"></p>
					<div class="img">
						<picture>
				...
				<div class="lecturer_box">
					<div class="text_box">
						<div class="name_box">
							...
							<p class="name_en"><img loading="lazy" src="<?php echo $imgPath; ?>/txt_recturer_eng.svg" alt="Masayoshi Fukuda"></p>
						</div>
		...
		<section id="price">
			...
			<div class="wrap">
				<div class="lead_box">
					<h2 class="lead_ttl">
						<picture>
							<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/img_price_lead_ttl_sp.webp" type="image/webp">
					...
					<div class="price_box">
						<p class="price"><img loading="lazy" src="<?php echo $imgPath; ?>/monthly_fee_pc.svg" alt="月額11,167円（税別）～ （12,283円税込〜/月）"></p>
				...
				<div class="select_box">
					<div class="flex">
						<p class="select_ttl">
							<picture>
								<source media="(max-width:812px)" srcset="<?php echo $imgPath; ?>/img_price_select_ttl_sp.webp" type="image/webp">
					...
					<div class="txt_box">
						...
						<p class="catch">
							<picture>
								...
								<img loading="lazy" src="<?php echo $imgPath; ?>/img_philosophy_01.png" alt="継続的にお客様に愛され、売れ続けるためのブランドを作る。">
							</picture>
						</p>
